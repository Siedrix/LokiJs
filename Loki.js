...
/* loki-controller.js */
(function(b){var c={};b.Events.on("Router::*::*",function(a){a=a.split("::");a.shift();c[a[0]]&&c[a[0]][a[1]]?(a=c[a[0]][a[1]],a.before&&a.before(),b.render({url:a.data,template:a.template,success:function(){}})):console.log("No controller or action ",a)});b.extend({Controller:{set:function(a,b){c[a]=b},getAll:function(){b.console.log(c)}}})})($L);
/* loki-template.js */
